...
from vehical.views import ListTopSongs, index, getCountries ,getPops
...
urlpatterns = [
    ...
    path('api/get/pop', getPops, name = "get_pops"),
    path('', Home,name="home"),
    path('user_home', User_Home,name="patient_home"),
